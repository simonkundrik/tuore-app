# -*- coding: utf-8 -*-
"""Appends forktospoon_recipes.json into the `let meals=[...]` array in
...
DATA_PATH = Path(__file__).parent / "forktospoon_recipes.json"
...
def main():
    ...
    print(f"Inserted {len(new_ones)} new Fork To Spoon air-fryer recipes ({skipped} already present, skipped)")
