# -*- coding: utf-8 -*-
"""Appends quick_recipes.json into the `let meals=[...]` array in
...
DATA_PATH = Path(__file__).parent / "quick_recipes.json"
...
def main():
    ...
    print(f"Inserted {len(new_ones)} new quick recipes ({skipped} already present, skipped)")
